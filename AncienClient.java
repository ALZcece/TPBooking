...
public class AncienClient extends Client {
    ...
    public Client login(Scanner sc) {
        ...
        System.out.println("Connexion réussie! Bienvenue " + getPrenom() + "!");
        return this;
    }
    @Override
    public double getReduction() {
        if (nbReservations >= 10) {
            System.out.println("Merci pour votre fidélité " + getPrenom() + " ! 15% de réduction.");
            return 0.15;
        }
        return 0.0;
    }
    ...
    public void afficherHistorique() {
        System.out.println("Historique des réservations pour " + getPrenom() + " :");
